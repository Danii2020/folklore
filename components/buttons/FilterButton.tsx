...
const FilterButton = ({ onClick }:Props) => (
  <button
    ...
    py-1 px-2 transition duration-300 ease-in-out transform
    hover:scale-105 hover:shadow-lg gap-1 border-2 border-black"
  >
    <span
      className="w-[18px] h-[18px] inline-block align-middle"
    >
      <svg
    ...
    <span
      className={`${styles.smallText} font-medium md:block hidden`}
    >
      Todos los filtros
    </span>
  </button>
